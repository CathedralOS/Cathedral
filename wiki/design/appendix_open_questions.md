...
- **Formal atomics and modular protocols.** Cathedral's mailbox, scheduler, and
  ...
  environment premises in Omega owner question #6. Existing instruction
  selection is not yet that proof.
- **Opaque executable trust and contained failure.** Omega owner questions #4
  and #5 must settle root-level TCB visibility/profile rejection for
