...
- **Formal atomics and modular protocols.** Cathedral's mailbox, scheduler, and
  ...
  environment premises in Omega owner question #9. Existing instruction
  selection is not yet that proof.
- **Opaque executable trust and contained failure.** Omega owner questions #7
  and #8 must settle root-level TCB visibility/profile rejection for
