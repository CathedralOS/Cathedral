...
- **Evolving driver APIs.** Kernel↔driver and driver↔client interfaces use
  ordinary numbered schemas, layout/codec policies, immutable historical
  shapes, checked conversions, and channel-declared compatibility windows.
  Live driver replacement is a separate component protocol over running
  providers and retained state.
