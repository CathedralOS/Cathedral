...
- **Constraint-bearing materialization + checked assembly** cover first publication of loader tables, executable regions, and AP trampolines; this is distinct from later component replacement.
