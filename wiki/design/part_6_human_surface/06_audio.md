...
- Buffer formats (sample rate, channel layout, frame size) are ordinary numbered schemas under a selected wire codec ([wire protocols](../../../../Omega/wiki/language_guide/chapter_21_wire_protocols.md)) shared by client and server.
