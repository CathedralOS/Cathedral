...
- **Typed schemas + ordinary migration machines** fit long-lived configuration
  whose shape evolves — see Omega
...
- **Numbered protocol schemas + codec policies** give stable external encoding
  for configuration that is exported, synchronized, or read by tooling — see
  Omega [Protocol Schemas And Serialization](../../../../Omega/wiki/language_guide/chapter_21_wire_protocols.md).
