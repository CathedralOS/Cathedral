...
assert record['omega_fixtures']==8 and record['body_controls']==8
print('Verified tested encrypted projection source/fixture hashes;240 cases,8 fixtures,8 controls.')
