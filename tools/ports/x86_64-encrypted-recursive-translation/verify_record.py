...
assert record['omega_fixtures']==55 and record['body_controls']==8
print('Verified tested encrypted recursive translation source/fixture hashes;330 observations,55 fixtures,8 controls.')
