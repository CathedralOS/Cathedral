...
impl ObservedEntry {
 pub fn new(word:u64)->Self {let mut value=PageTableEntry::new();value.set_addr(PhysAddr::new(word&0x000ffffffffff000),PageTableFlags::from_bits_retain(word&!0x000ffffffffff000));Self{value,writes:0}}
