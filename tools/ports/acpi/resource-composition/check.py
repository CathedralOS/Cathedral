#!/usr/bin/env python3
"""Check and execute real Omega resource-composition bodies and changed-body controls."""
...
def main():
 ...
 before=snapshot()
 with tempfile.TemporaryDirectory(prefix='cathedral-acpi-resource-composition-')as directory:
