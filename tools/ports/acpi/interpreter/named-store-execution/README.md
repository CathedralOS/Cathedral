...
The current 58 bytecode pairs cover both integer widths, direct basic source/target
...
case; subsequent equal-extent support has its own component receipts. The 38
...
python3 tools/ports/acpi/interpreter/named-store-execution/check.py --group execution --record tools/ports/acpi/interpreter/named-store-execution/integrated-execution-verification.json
python3 tools/ports/acpi/interpreter/named-store-execution/check.py --group bridge --record tools/ports/acpi/interpreter/named-store-execution/integrated-bridge-verification.json
python3 tools/ports/acpi/interpreter/named-store-execution/check.py --verify tools/ports/acpi/interpreter/named-store-execution/integrated-execution-verification.json
python3 tools/ports/acpi/interpreter/named-store-execution/check.py --verify tools/ports/acpi/interpreter/named-store-execution/integrated-bridge-verification.json
```
...
All six original checkpoint suites pass: 44 new bytecode, 30 bridge, 25 target-dispatch,
...
The expanded 58/38 integration suites add equal/self/empty Buffer copying,
Integer and admitted String conversion into zero-length Buffers, complete
failure preservation for malformed Strings even at zero extent, and exact
destination object identity for successful named String/Buffer results. They
