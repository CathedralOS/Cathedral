#!/usr/bin/env python3
"""Run named Store integration through actual Omega bodies and bind exact inputs."""
import argparse
import hashlib
import json
import os
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='cathedral-named-store-execution-') as directory:
