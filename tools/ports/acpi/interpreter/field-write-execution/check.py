...
def build():
    text='machine build(builder:&mut Build){builder.package("field-write-execution");builder.freestanding=true;'
    for alias,path in [('aml','source/libraries/acpi/aml'),('execution','source/libraries/acpi/interpreter/execution'),('integer_helpers','source/libraries/acpi/interpreter')]:
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='cathedral-write-retirement-') as name:
