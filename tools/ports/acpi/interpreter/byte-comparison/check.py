#!/usr/bin/env python3
"""Check and execute real Omega byte-comparison bodies and changed-body controls."""
...
def main():
 ...
 before=snapshot()
 with tempfile.TemporaryDirectory(prefix='cathedral-acpi-byte-comparison-')as directory:
