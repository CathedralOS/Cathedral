...
import fixtures
HERE=fixtures.HERE;ROOT=fixtures.ROOT;CANONICAL=ROOT;SHARED=CANONICAL/'tools/ports/acpi/interpreter/execution'
PIN='eaa7993a23623cd8fabf45350340479c5c9c7879'
SOURCE=['source/libraries/acpi/aml/'+n for n in ['build.omg','model.omg','values.omg','bytes.omg','names.omg','namespace.omg','object_references.omg','byte_storage.omg']]+['source/libraries/acpi/interpreter/'+n for n in ['build.omg','integers.omg','conversions.omg','buffer_fields.omg','execution/build.omg','execution/byte_literals.omg']]
...
def build_runner(omega):
 ...
 target=Path('/tmp/cathedral-acpi-byte-literal-runner')
...
def main():
 ...
 print('PASS',len(rows),'literal preflight pairs')
