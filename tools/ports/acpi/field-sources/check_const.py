#!/usr/bin/env python3
"""Representative actual payload sequencing bodies evaluated as constants, with body controls."""
...
def selected():
 names=['buffer_3_9_2_False','integer_32_65_0','encoding_tail_end_True'];rows=fixtures.cases();return [next(r for r in rows if r['name']==name)for name in names]
...
def main():
 ...
 for row in selected():
  for control in [False,True]:
   ...
   with tempfile.TemporaryDirectory(prefix='cathedral-field-sources-const-')as d:
