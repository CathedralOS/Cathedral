#!/usr/bin/env python3
"""Evaluate representative direct object descriptions as constant expressions."""
...
def main():
 ...
 inputs=check.snapshot();binary=check.sha(compiler);selected=['Uninitialized_63_True','BufferField_31_True','invalid_Device_count_max'];rows={r['name']:r for r in fixtures.cases()};proofs=[]
 for name in selected:
  for control in [False,True]:
   with tempfile.TemporaryDirectory(prefix='cathedral-object-description-constant-')as d:
