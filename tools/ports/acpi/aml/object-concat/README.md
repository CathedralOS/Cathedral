...
The retained receipt records 314 actual checked positives and 314 changed-body
controls, plus three constant positives and rejecting controls. Expectations use
independent Python numeric and byte operations. Successful results compare the
...
directories and deterministic receipt order. It binds its exact 18-file Omega
