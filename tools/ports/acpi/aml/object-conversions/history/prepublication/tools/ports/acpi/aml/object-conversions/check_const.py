...
def main():
 inputs=check.snapshot();binary=check.sha(compiler);selected=['integer_32_1311768467139281697','owned_dirty_tail_Buffer_buffer','invalid_id_max_integer'];rows={r['name']:r for r in fixtures.cases()};proofs=[]
