...
def main():
 inputs=check.snapshot();binary=check.sha(compiler);selected=['integer_Hexadecimal_32_18446744073709551615','buffer_pattern_Decimal_16_15_True','encoding_Decimal_256_255_True'];rows={r['name']:r for r in fixtures.cases()};proofs=[]
