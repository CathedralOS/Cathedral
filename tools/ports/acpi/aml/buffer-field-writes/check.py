...
SOURCE=['source/libraries/acpi/aml/'+n for n in ['build.omg','model.omg','buffer_field_writes.omg','bytes.omg','names.omg','namespace.omg','object_references.omg','byte_storage.omg']]+['source/libraries/acpi/interpreter/'+n for n in ['build.omg','integers.omg','conversions.omg','buffer_fields.omg']]
...
def build_runner(omega):
 ...
 target=Path('/tmp/cathedral-acpi-buffer-field-write-runner')
...
def main():
 ...
 print('PASS',len(rows),'atomic field-write pairs')
