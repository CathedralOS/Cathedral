...
Scratch-only helper, no runtime or existing dependency edits. The source uses
...
catalog, public Rust probe/lock and checked-runner source/lock. A copied baseline
also proves existing canonical modules remain unchanged. No shared runner is
