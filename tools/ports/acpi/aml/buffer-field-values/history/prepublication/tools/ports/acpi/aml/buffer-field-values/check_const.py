...
def main():
 inputs=check.snapshot();binary=check.sha(compiler);selected=['bits_32_32_at_7_False','bits_64_129_at_0_True','field_max'];rows={r['name']:r for r in fixtures.cases()};proofs=[]
