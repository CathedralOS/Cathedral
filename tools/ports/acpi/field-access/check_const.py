#!/usr/bin/env python3
"""Representative actual geometry/chunk bodies evaluated as constants, with body controls."""
...
def selected():
 names=['geometry_2_1_17','offset_max','merge_8_3_5_1_0_1'];rows=fixtures.cases();return [next(r for r in rows if r['name']==name)for name in names]
...
def main():
 ...
 for row in selected():
  for control in [False,True]:
   ...
   with tempfile.TemporaryDirectory(prefix='cathedral-field-access-const-')as d:
