#!/usr/bin/env python3
"""Execute actual bounded read assembly bodies against independent interval vectors."""
...
def main():
 ...
 def run_batch(selected):
  ...
  with tempfile.TemporaryDirectory(prefix='cathedral-field-values-checked-')as d:
