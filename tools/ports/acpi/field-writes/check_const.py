#!/usr/bin/env python3
"""Representative actual write assembly bodies evaluated as constants, with body controls."""
...
def selected():
 names=['geometry_2_1_17','late_missing','count_capacity_1_18446744073709551615'];rows=fixtures.cases();return [next(r for r in rows if r['name']==name)for name in names]
...
def main():
 ...
 for row in selected():
  for control in [False,True]:
   ...
   with tempfile.TemporaryDirectory(prefix='cathedral-field-writes-const-')as d:
