...
def main():
 ...
 print('PASS 610 adapted constructor observations across10 isolated profiles',flush=True)
 ...
 def evaluate(body,mutation=None):
  ...
  with tempfile.TemporaryDirectory(prefix='cathedral-encrypted-constructor-') as folder:
 ...
 for n in range(args.start,args.end):
  ...
  evaluate(body,('physical_frame==want_frame','physical_frame!=want_frame'));print('PASS observed frame mutation',n,flush=True)
