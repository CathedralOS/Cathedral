#!/usr/bin/env python3
"""Execute the storage Omega fixtures by semantic evaluation, with a negative control."""
import argparse
import hashlib
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='cathedral-uefi-storage-negative-') as directory:
        root = Path(directory)
    ...
    print('Storage constant tests passed in Omega semantic evaluation; negative assertion rejected.')
