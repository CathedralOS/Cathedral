#!/usr/bin/env python3
"""Execute the scalar Omega fixtures by semantic evaluation, with a negative control."""
import argparse
import hashlib
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='cathedral-uefi-scalars-negative-') as directory:
        root = Path(directory)
    ...
    print('Scalar tests passed in Omega semantic evaluation; negative assertion rejected.')
