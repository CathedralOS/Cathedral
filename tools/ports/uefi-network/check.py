#!/usr/bin/env python3
"""Execute the network Omega fixtures by semantic evaluation, with a negative control."""
import argparse
import hashlib
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='cathedral-uefi-networks-negative-') as directory:
        root = Path(directory)
    ...
    print('Network tests passed in Omega semantic evaluation; negative assertion rejected.')
