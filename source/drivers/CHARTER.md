...
pre-timer exception floor; and `facts/pic_8259` plus `facts/pit_8254` for the
first timer path. These files grant no hardware authority and are not driver
programs or interrupt providers.
