...
| Exhaustion and unsupported behavior | Explicit Capacity, DepthLimit, WorkLimit and unsupported/unresolved outcomes; graph rejection clears exposed result data while retaining earlier execution effects. | Loader rollback, unsupported opcodes/objects, regions/services, malformed packages, and graph rejection fixtures. |
