...
is transcribed in the isolated write-execution branch. Its 34 whole-state pairs
are authored, with full checked verification running. Pending Store/scalar
...
[Retained normal Field write pipeline](pipeline/field-writes.PORT.md)
...
[Concatenate opcode retirement](interpreter/execution/concat.PORT.md) is transcribed in an
